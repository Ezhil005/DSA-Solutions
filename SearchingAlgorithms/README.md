...
- [SquareRootBinarySearch.java](https://github.com/Ezhil005/DSA-Solutions/blob/master/MathAlgorithms/SquareRootBinarySearch.java): Computes the floor of the square root of a non-negative integer using binary search. Handles large inputs and avoids overflow. Time complexity: O(log A).
